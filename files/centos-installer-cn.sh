...
linux${EFI} /vmlinuz ip=dhcp inst.repo=${MIRROR_PREFIX}/BaseOS/x86_64/os inst.ks=http://www.timectrl.net/files/centos-kickstart-cn.txt inst.text inst.vnc inst.vncpassword=PaFfW0rd
