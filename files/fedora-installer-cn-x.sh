...
MIRROR_PREFIX=https://dl.fedoraproject.org/pub/fedora/linux/releases/35/
MIRROR_PREFIX=https://mirror.sjtu.edu.cn/fedora/linux/releases/35
MIRROR_PREFIX=http://mirrors.163.com/fedora/releases/35
MIRROR_PREFIX=http://mirrors.huaweicloud.com/fedora/releases/35
MIRROR_PREFIX=http://repo.huaweicloud.com/fedora/releases/35
